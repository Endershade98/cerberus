...
class DjangoUnitOfWork(UnitOfWork):
    ...
    def _build_member_repository(self):
        ...
        from src.infrastructure.django_app.persistence.django.repositories.member_repository import (
    ...
    def _build_energy_repository(self):
        ...
        from src.infrastructure.django_app.persistence.django.repositories.energy_repository import (
